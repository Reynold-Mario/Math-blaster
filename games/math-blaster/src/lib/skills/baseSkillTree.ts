...
export type BaseSkillCategory =
	'economy' | 'movement' | 'defense' | 'firing' | 'active' | 'progression';
...
const checkpoint: SkillNode<BaseSkillEffect> = {
	...
	name: 'Checkpoint',
	description:
		'Start a run at a later wave, for free, every time - never further than you have already reached.',
	maxLevel: 3,
...
export const BASE_SKILL_NODE_CATEGORY: Partial<Record<string, BaseSkillCategory>> =
	Object.fromEntries(
