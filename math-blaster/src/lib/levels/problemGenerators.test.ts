...
describe('attributing a problem to its topic', () => {
  const g1 = { id: 'g1-add-sub-10', standardCode: '1.OA.6', operations: ['+', '-'] as const, numberRange: [1, 10] as [number, number] };
  const noCode = { id: 'g2-mult-foundation', operations: ['×'] as const, numberRange: [2, 3] as [number, number] };
