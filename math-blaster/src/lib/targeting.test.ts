import { resolveTarget, weakPointXPct, ALIGNMENT_TOLERANCE_PCT, WEAK_POINT_TOLERANCE_PCT } from './targeting';
...
describe('resolveTarget', () => {
  ...
  it('picks the aligned enemy closest to the impact line among several stacked in the same lane', () => {
    ...
    expect(resolveTarget(makePlayer(50), [far, near], null)).toEqual({ kind: 'enemy', enemy: near });
  });
